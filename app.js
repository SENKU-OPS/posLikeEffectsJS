...
window.addEventListener('scroll', () => {
    ...
    if (imagePositionSection1 < windowHeight) {
        imageSection1.style.transform = "translateY(0px)";
        imageSection1.style.opacity = "1";

    } else {
        if (window.innerHeight < 650) {
            imageSection1.style.transform = "translateY(110px)";
        } else {
...
window.addEventListener('scroll', () => {
    ...
    if (imagePositionSection2 < windowHeight) {
        imageSection2.style.transform = "translateY(0px)";
        imageSection2.style.opacity = "1";

    } else {
        if (window.innerHeight < 650) {
            imageSection2.style.transform = "translateY(110px)";
        } else {
